  ...
  static WordsTrainGameManagerMock getWordsTrainGameManagerMocked() =>
      WordsTrainGameManagerMock(
        ...
        problem: MocksConfiguration.useProblemMock
            ...
            : null,
        players: [
          Player(login: 'player1', displayName: 'Player 1')
            ..score = 100
            ..starsCollected = 1,
          Player(login: 'player2', displayName: 'Player 2')
            ..score = 200
            ..starsCollected = 2
            ..addToStealCount(),
          Player(login: 'player3', displayName: 'Player 3')..score = 300,
          Player(login: 'player4', displayName: 'Player 4')..score = 150,
          Player(login: 'player5', displayName: 'Player 5')
            ..score = 250
            ..addToStealCount()
            ..addToStealCount()
            ..addToStealCount(),
          Player(login: 'player6', displayName: 'Player 6')..score = 350,
          Player(
              login: 'player_with_a_very_very_very_long_name',
              displayName: 'PlayerWithAVeryVeryVeryLongName')
            ..score = 400
            ..addToStealCount()
            ..addToStealCount(),
          Player(
              login: 'another_player_with_a_very_very_very_long_name',
              displayName: 'AnotherPlayerWithAVeryVeryVeryLongName')
            ..addToStealCount()
            ..addToStealCount()
            ..addToStealCount()
            ..score = 350,
        ...
        nextMiniGame: MiniGames.warehouseCleaning,
